const AboutUs = () => {
  return (
    <div className="min-h-screen w-screen mx-auto px-4 py-8 bg-white">
      <div className="grid grid-cols-3 gap-8">
        <div className="col-span-2">
          <h1 className="text-3xl font-bold mb-4 text-gray-900">About ChasmaPasal</h1>
          <p className="mb-8 text-justify text-gray-700">
          ...
          <h2 className="text-2xl font-bold mb-4 text-gray-900">Why Choose ChasmaPasal</h2>
          <ul className="list-disc pl-6 mb-8 text-justify text-gray-700">
